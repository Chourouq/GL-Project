...
const LawyerFrame7 = () => {
  ...
  const profileData = {
    profilePicture:"https://avocatalgerien.com/wp-content/uploads/2016/01/imageitalia.jpg",
    firstName: "NAWEL SEKKAL CABINET D’AVOCATS INTERNATIONAL AVOCAT À ROME",
    lastName: 'AVOCAT À ROME',
    lawSpecialty: "Droit civil",
